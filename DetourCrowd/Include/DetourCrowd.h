...
enum MoveRequestState
{
	...
	DT_CROWDAGENT_TARGET_VALID,		// 当前的corridor可到达目标（非阶段性corridor）
	DT_CROWDAGENT_TARGET_REQUESTING,
	DT_CROWDAGENT_TARGET_WAITING_FOR_QUEUE,	// 当前corridor不完整，等待加入pathQueue，查询完整path
	DT_CROWDAGENT_TARGET_WAITING_FOR_PATH,	// 已经加入了pathQueue，等待出结果
